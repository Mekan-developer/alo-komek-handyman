                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-1">
                                        ...
                                        <button
                                            ...
                                            :disabled="category.orders_count > 0"
                                            class="rounded-lg p-2 text-slate-400 transition-all duration-150 enabled:hover:bg-red-100 enabled:hover:text-red-600 disabled:cursor-not-allowed disabled:opacity-40 dark:enabled:hover:bg-red-500/15 dark:enabled:hover:text-red-400"
                                            :title="category.orders_count > 0
                                                ? t('categories.delete_blocked', { count: category.orders_count })
