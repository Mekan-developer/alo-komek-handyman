...
return [
    ...
    'receipt' => [
        ...
        'discount' => 'Скидка',
        'total' => 'ИТОГО',
        'no_items' => 'Задачи без стоимости — чек пустой',
        'not_issued' => 'Чек создаётся автоматически после завершения заявки',
    ...
    'modals' => [
        ...
        'complete_no_price_warning' => 'Не у всех задач указана цена. Завершить заявку можно только после того, как цена указана для каждой задачи.',
    ...
    'errors' => [
        ...
        'unpriced_tasks' => 'Заказ не может быть завершён — для каждой работы администратор должен установить цену.',
        'task_not_owned' => 'Эта задача принадлежит другой заявке',
        'task_not_editable' => 'Задачу можно редактировать только пока заявка в работе',
        'task_photo_not_editable' => 'Фото можно заменить только пока заявка в работе',
    ],
];
